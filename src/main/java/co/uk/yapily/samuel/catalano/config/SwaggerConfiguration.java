...
public class SwaggerConfiguration {
    ...
    public static final String BASE_PACKAGE = "co.uk.yapily.samuel.catalano";
    ...
    private ApiInfo customApiInfo() {
        return new ApiInfoBuilder().title("Yapily Code Challenge")
                .description("Yapily Management OPEN REST API")
